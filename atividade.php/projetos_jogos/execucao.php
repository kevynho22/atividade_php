...
do {
    ...
    switch ($opcao) {
        ...
        case 2:
            ...
            foreach ($jogos as $j) {
                echo "ID: {$j['id']} | {$j['nome']} | {$j['genero']} | {$j['plataforma']} | {$j['ano_lancamento']} | {$j['desenvolvedora']}\n";
            }
        break;
        ...
        case 3:
            ...
            if ($jogo != null) {
                ...
                echo "ID: {$jogo['id']}\n";
                echo "Nome: {$jogo['nome']}\n";
                echo "Gênero: {$jogo['genero']}\n";
                echo "Plataforma: {$jogo['plataforma']}\n";
                echo "Ano: {$jogo['ano_lancamento']}\n";
                echo "Desenvolvedora: {$jogo['desenvolvedora']}\n";
            } else {
